...
Per-agent VAD thresholds, turn-stop strategy (including semantic end-of-turn), backchannel filtering, STT endpointing, and tool-call fillers are configured from **Settings → General**. See [Voice Runtime](/configurations/voice-runtime).
